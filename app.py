...
def generar_reporte_quincenal_html(registros, periodo_label):
    ...
    for (direccion, tramo, proceso), regs in sorted(grupos.items()):
        ...
        # ---- GABINETE (Productos y Sistemas Geoespaciales, sin propiedad) ----
        gabinete = [r for r in regs
                    if (direccion or '').strip().upper() == 'PRODUCTOS Y SISTEMAS GEOESPACIALES'
                    and not (r.tipo_propiedad and r.tipo_propiedad.strip())]
        if gabinete:
            ...
            <div class="pagina">
                <div class="encabezado-pagina">
                    <div class="encabezado-texto">
                        ...
                        <p class="liberacion">Actividades realizadas en gabinete</p>
                    </div>
                    <div class="encabezado-logo"></div>
                </div>
                <div class="seccion-header verde">
                    ACTIVIDADES REALIZADAS EN GABINETE &ndash; PRODUCTOS Y SISTEMAS GEOESPACIALES
                </div>
                <div class="seccion-body">{bloques_r}</div>
                <div class="seccion-header guinda">
                    ACTIVIDADES PROGRAMADAS DEL {quincena} EN GABINETE
                </div>
